// Authed shell. The sidenav that wraps the dashboard, speeches, settings,
// and recorder. Onboarding lives outside this shell so the first-run
// experience is full-bleed.
//
